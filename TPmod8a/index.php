...
<html lang="en">
  <head>
    ...
    <title>TP MOD 8 - {1301154336}</title>
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
        <nav class="navbar">
          ...
          <img src="images/logo.png" width="30" height="30" alt=""> TP Mod 8 {M. Fathan} {1301154336}
          </a>
        </nav>
    </nav>
      <div class="row">
          ...
          <table id="example" class="display" style="width:100%">
            ...
            <tbody>
                ...
                /* Insert Your Query to get Data from database*/
                    include('config.php');
                    $sql =mysqli_query($conn,"SELECT * FROM participants JOIN users ON users.id_users=participants.id_users") ;
                    $no = 1;
                   foreach ($sql as $data) {
                    ?>
                    <!-- Show data Here -->
                 ...
                 <div class="modal fade" id="edit<?php echo $data['id_users']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <h5 class="modal-title" id="exampleModalLabel">Data <?php echo $data['name']?></h5>
                              <!-- Insert Form here -->
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                         <h5 class="modal-title" id="exampleModalLabel">Are you sure to delete <?php echo $data['id_users']?> ?</h5>
                      </div>
